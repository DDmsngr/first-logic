...
const NOTIFY_KINDS: { id: string; label: string; hint: string }[] = [
  ...
  { id: 'order', label: 'Заказы поставщикам', hint: 'заказ принят на склад' },
  { id: 'test', label: 'Брак на испытаниях', hint: 'изделие не прошло по допускам' },
  { id: 'digest', label: 'Утренняя сводка', hint: 'в 9:00 МСК: сроки на сегодня, просрочки, что заказать, какие поставки ждём' },
]
