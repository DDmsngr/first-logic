...
export interface SearchResult {
  ...
  files: { id: string; task_id: string | null; component_id: string | null; supplier_id: string | null; product_id: string | null; assembly_id: string | null; expense_id: string | null; filename: string; size: number }[]
  expenses: { id: string; spent_on: string; description: string; amount_rub: number }[]
